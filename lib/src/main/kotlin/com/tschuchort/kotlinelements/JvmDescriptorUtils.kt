...
/**
 * Adapted from https://github.com/square/kotlinpoet/blob/master/kotlinpoet-classinspector-elements/src/main/kotlin/com/squareup/kotlinpoet/classinspector/elements/JvmDescriptorUtils.kt
 */
 ...
 * For reference, see the [JVM specification, section 4.3](http://docs.oracle.com/javase/specs/jvms/se7/html/jvms-4.html#jvms-4.3).
 */
internal object JvmDescriptorTypeVisitor : AbstractTypeVisitor14<String, Types>() {
	...
	override fun visitIntersection(t: IntersectionType, p: Types): String = error("Unsupported type $t")
	override fun visitUnion(t: UnionType, p: Types): String = error("Unsupported type $t")
}