 ...
 */
internal interface HasKotlinTypeParameters : HasTypeParameters {
	fun lookupKJTypeParameterFor(javaxTypeParam: TypeParameterElement): KotlinTypeParameterElement
}