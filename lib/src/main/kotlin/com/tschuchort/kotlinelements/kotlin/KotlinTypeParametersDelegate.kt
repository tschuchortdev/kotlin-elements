...
internal class KotlinTypeParametersDelegate(
	...
	private val convertedElements: LinkedHashMap<TypeParameterElement, KotlinTypeParameterElement> by lazy {
		...
		val matchedTypeParams = kmTypeParams.zipWith(javaxTypeParams) { kmTypeParam, javaxTypeParam ->
			if (doTypeParamsMatch(javaxTypeParam, kmTypeParam)) {
				val kjTypeParam = KotlinTypeParameterElement(
	...
	override fun lookupKJTypeParameterFor(javaxTypeParam: TypeParameterElement): KotlinTypeParameterElement {
